...
def fetch_assignments_for_course(course_id, headers, params):
    base_url_assignments = f'https://canvas.lms.unimelb.edu.au/api/v1/courses/{course_id}/assignments'
    all_assignments = []
...
def get_enrolled_users_with_roles(course_id, headers):
    base_url = f"https://canvas.lms.unimelb.edu.au/api/v1/courses/{course_id}/enrollments?per_page=10000000"
    all_enrollments = []
    fetched_urls = set()
    # while base_url:
